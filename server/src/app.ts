...
server.use((_req, res, next) => {
  res.header('Access-Control-Allow-Origin', process.env.ORIGIN || 'http://localhost:5173') // 'http://localhost:3000'); // update to match the domain you will make the request from
